...
const ViewTodo = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `${backendUrl}/api/todo/update-todo/${currentTodoId}`,
        todo,
        {
          headers: { token },
        }
  ...
  const getTodoById = async (id) => {
    try {
      const response = await axios.get(
        `${backendUrl}/api/todo/get-todo/${id}`,
        {
          headers: { token },
        }
      );
  ...
  const markAsCompleted = async (id) => {
    try {
      const response = await axios.put(
        `${backendUrl}/api/todo/update-todo-status/${id}`,
        {},
        {
          headers: { token },
        }
  ...
  return (
    <div className="min-h-screen  bg-[#111]  py-16 px-4 sm:px-6 lg:px-8">
        ...
        {showTodo?.map((item) => (
          ...
          >
            ...
            <div className="flex justify-between items-start">
              <h2 className="font-bold font-mathilde text-5xl text-gray-800">
                {item.title}
              </h2>
              <span
            ...
            {/* Description */}
            <p className="text-gray-600 mt-4 mb-6 font-mathilde text-5xl leading-none">
              {item.description}
            </p>
            ...
            <div className="mt-6 flex justify-between items-center">
              ...
              <button
                ...
                className="flex items-center text-indigo-500 hover:text-indigo-600 font-medium transition mr-4"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <button
                ...
                className="flex items-center bg-red-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-red-600 transition mr-4"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
